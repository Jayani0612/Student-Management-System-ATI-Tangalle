...
$pageTitle = 'Courses';
$pageSubTitle = 'Manage course catalog, credits and instructors';
...
<title>ATI Tangalle · Courses</title>
        ...
        <div class="content">
            <div class="card panel">
                <div class="table-toolbar">
                    <div>
                        <h3 class="panel-title"><i class="fas fa-book" style="color:var(--primary-light);margin-right:8px;"></i>Course Records</h3>
                        <div class="panel-sub">Manage course catalog, credits and instructors</div>
                    </div>
                    <div style="display:flex;gap:12px;align-items:center;flex-wrap:wrap">
                        <div class="table-search">
                            <i class="fa-solid fa-magnifying-glass"></i>
                            <input type="text" id="searchInput" placeholder="Search course name or code...">
                        </div>
                        <button class="btn btn-primary" onclick="openAddModal()"><i class="fa-solid fa-plus"></i> Add Course</button>
                    </div>
                </div>
                ...
                <div class="pagination">
                    <span id="resultCount">0 courses</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal-overlay" id="courseModal">
    <div class="modal">
        <div class="modal-head">
            <h3 id="modalTitle"><i class="fas fa-plus-circle" style="color:var(--primary-light);margin-right:8px;"></i>Add Course</h3>
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="course_code" name="course_code" class="form-control" placeholder="e.g., CS301" required>
                    </div>
                    <div class="form-group">
...
function openAddModal() {
    document.getElementById('modalTitle').innerHTML = '<i class="fas fa-plus-circle" style="color:var(--primary-light);margin-right:8px;"></i>Add Course';
...
function openEditModal(id) {
    document.getElementById('modalTitle').innerHTML = '<i class="fas fa-edit" style="color:var(--primary-light);margin-right:8px;"></i>Edit Course';
    document.getElementById('courseId').value = id;
    
    fetch(`api/courses_api.php?action=get&id=${id}`)
        .then(res => res.json())
        .then(data => {
            if (data.success) {
                ...
                showToast(data.message || 'Error loading course data', 'error');
            }
        })
        .catch(err => {
...
function loadCourses() {
    ...
    fetch(`api/courses_api.php?action=list&search=${encodeURIComponent(search)}`)
        .then(res => res.json())
        .then(data => {
            if (!data.success) {
                tbody.innerHTML = `<tr><td colspan="7" style="text-align:center;color:var(--red);padding:40px;">
                    ...
                    ${data.message || 'Error loading courses'}
                </td></tr>`;
                document.getElementById('resultCount').textContent = '0 courses';
                return;
            }
            ...
            document.getElementById('resultCount').textContent = `${courses.length} courses`;
        })
        .catch(err => {
            tbody.innerHTML = `<tr><td colspan="7" style="text-align:center;color:var(--red);padding:40px;">
                <i class="fas fa-exclamation-circle" style="font-size:24px;display:block;margin-bottom:10px;"></i>
